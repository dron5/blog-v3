module.exports = {
  ...
  rules: {
    ...
    semi: ['warn', 'always'], // точка с запятой в конце операторов
    // 'react/jsx-indent': [2,{ indentMode:2, ignoreTernaryOperator: true }],
    indent: ['error', 2, { SwitchCase: 1 }], // отступы в коде из 2 пробелов с учетом switch...case
    'arrow-parens': ['error', 'as-needed'], // скобки вокр одного параметра стр.функ
